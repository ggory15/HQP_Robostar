...
void HQP::robot::RobotModel::setRobot() {
	...
	axis_[3] = Eigen::Vector3d::UnitY();
	axis_[4] = -1.0*Eigen::Vector3d::UnitZ();
	axis_[5] = -1.0*Eigen::Vector3d::UnitY();
	axis_[6] = -1.0*Eigen::Vector3d::UnitZ();

	joint_position_global_[0] = Eigen::Vector3d(0.0, 0.0, 0.0);
	joint_position_global_[1] = Eigen::Vector3d(0.0, 0.0, 0.223);
	joint_position_global_[2] = Eigen::Vector3d(0.0, 0.118, 0.223);
	joint_position_global_[3] = Eigen::Vector3d(0.0, 0.118, 0.5634);
	joint_position_global_[4] = Eigen::Vector3d(0.0, 0.0, 0.5634);
	joint_position_global_[5] = Eigen::Vector3d(0.0, 0.0, 0.8634);
	joint_position_global_[6] = Eigen::Vector3d(0.0, 0.112, 0.9634);
	...
	com_position_[6] = Vector3d(-0.0, 0.112, 1.0246);
